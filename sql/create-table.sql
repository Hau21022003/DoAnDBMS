...
CREATE TABLE ACCOUNT (
    ...
    employee_id INT CONSTRAINT FK_EMPLOYEE_ACCOUNT REFERENCES EMPLOYEE(employee_id) ON DELETE CASCADE, -- KHI XÓA NH N VIÊN THÌ SẼ XÓA TÀI KHOẢN NH N VIÊN TƯƠNG ỨNG
);
...
CREATE TABLE PHONE_NUMBER_OF_CUSTOMER (
	...
	customer_id INT UNIQUE CONSTRAINT FK_CUSTOMER_PHONE_NUMBER REFERENCES CUSTOMER(customer_id),
...
CREATE TABLE PHONE_NUMBER_OF_EMPLOYEE (
	...
	employee_id INT UNIQUE CONSTRAINT FK_EMPLOYEE_PHONE_NUMBER REFERENCES EMPLOYEE(employee_id),
